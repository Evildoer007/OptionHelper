...
| 平台 | 输出目录 | 目标文件 |
| --- | --- | --- |
| macOS | `dist/` | `option-helper-v0.3.0.zip`、`OptionHelper-v0.1.0-alpha-macOS-arm64.dmg` |
| Windows | `result/windows-candidate/` | `option-helper-v0.3.0.zip`、`OptionHelper-v0.1.0-alpha-Windows-x64.exe` |

当前版本：Skill为`v0.3.0`，App为`v0.1.0-alpha`。安装包和ZIP带版本号，解压后的目录与应用名称保持不变。
